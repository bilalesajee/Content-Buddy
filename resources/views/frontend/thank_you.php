...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?= asset('userasset/template') ?>/style/style.css">
    </head>
    <body>
        ...
        <div class="header">
            <a href="<?=url('/');?>" class="logo"><img src="<?= asset('userasset/template') ?>/images/logo.png" alt="Content Buddy"></a>
        </div>

        <div class="page_body">
            <div class="container">
                <div class="icon">
                    <img src="<?= asset('userasset/template') ?>/images/image1.png" alt="image">
                </div>
                <div class="divider">
                    <span></span>
                </div>
                ...
                <div class="thanks_popup">
                    ...
                    <div class="popup-body">
                        <div class="icon_envelop">
                            <img src="<?= asset('userasset/template') ?>/images/icon-envelope.png" alt="thumbs-up">
                        </div>
                        <div class="title">
