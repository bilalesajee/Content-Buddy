...
<table style="height:100%; margin: 0 auto;width: 600px;">
    <tr>
        <td>
            ...
            <table style="border-collapse:collapse; width:100%;">
                <tr>
                    <td style="padding-top: 60px; text-align: center;"><h1 style="margin: 0; font-size: 30px;">Reset your password!</h1></td>
                </tr>
                <tr>
                    <td style="font-size: 16px; padding:20px 0px 0px 30px">Hello <?= $full_name ?>,</td>
                </tr>
                <tr>
                    <td style="font-size: 16px; padding: 12px 0px 0px 30px">We received a request to reset your password.</td>
                </tr>
                <tr>
                    <td style="font-size: 16px; padding: 12px 0px 0px 30px">Click Below the button to reset your password!</td>
                </tr>
                <tr>
