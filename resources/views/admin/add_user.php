...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><input type="text"  class="form-control" name="phone" value="<?= (old('phone')) ? old('phone') : (isset($result->phone) ? $result->phone : ''); ?>"></div>
                        </div>
                        
<!--                        <div class="form-group">
                            <label class="col-sm-2 control-label">Type</label>
                            <div class="col-sm-10">
                                <?php $old_val =  (old('email')) ? old('email') :(isset($result->email) ? $result->email : '');?>
                                <select name="type" class="form-control">
                                    <option value="">User Type</option>
                                    <option value="user" selected="">User</option>
                                    <option value="adjuster" <?=($old_val == 'adjuster')?'selected':''?>>Adjuster</option>
                                </select>
                            </div>
                        </div>-->
